...
# List of item codes
item_codes = [
    "351830-test-old", "322127-old", "356004-old", "322126-old", "398108-old",
    "398300-Tt-old", "351850-old", "351845-old", "351844-old", "351843-old",
    "324001-old", "323001-old", "398107-old", "351842-old", "356000-old",
    "355006-old", "355001-old", "353007-old", "353006-old", "351841-old",
    "351836-old", "351835-old", "351834-old", "351833-old", "351832-old",
    "351830-old", "351820-old", "351818-old", "351816-old", "351815-old",
    "351038-old", "322120-old", "135578-old", "128019-old", "128017-old",
    "128016-old", "398200-old", "398105-old", "398104-old", "398103-old",
    "398101-old", "491805-old", "491806-old", "398000-old", "351826-old",
    "351823-old", "398300-old", "398102-old", "398201-old", "398106-old",
    "351820-1-old", "128014-old", "128015-old", "128018-old", "128020-old",
    "128021-old", "128022-old", "128531-old", "128532-old", "128534-old",
    "128535-old", "322121-old", "322122-old", "322123-old", "322124-old",
    "322125-old", "351829-old", "351831-old", "351837-old", "351838-old",
    "351839-old", "351840-old", "353005-old", "355002-old", "355003-old",
    "355004-old", "355005-old", "356001-old", "356002-old", "356003-old",
    "398001-old", "398002-old", "398003-old", "398004-old", "A063884-old",
    "486025-old"
]

@frappe.whitelist(allow_guest=True)
def update_bin_actual_qty():
    try:
        for item_code in item_codes:
            # Fetch all Bin entries for the given item code
            bins = frappe.get_all("Bin", filters={"item_code": item_code}, fields=["name", "actual_qty"])

            for bin in bins:
                # Update the actual_qty field to 0
                frappe.db.set_value("Bin", bin["name"], "actual_qty", 0)
                frappe.db.commit()

        frappe.msgprint("Updated actual_qty to 0 for all specified items in the Bin table.")
    except Exception as e:
        frappe.log_error(f"Error updating Bin table: {str(e)}", "Update Bin Actual Qty")
        frappe.throw(f"An error occurred while updating the Bin table: {str(e)}")

# Run the update function
update_bin_actual_qty()
